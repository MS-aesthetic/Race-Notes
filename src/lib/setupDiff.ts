...
export function diffSetups(a: Setup, b: Setup): SetupDiffRow[] {
  ...
  const cornerFields: [string, string][] = [
    ...
    ['Bottom Bar Angle (Ride Height)', 'bottomBarAngRH'],
    ['Bottom Bar Angle (Full Droop)', 'bottomBarAngFD'],
    ['Bottom Bar Angle (Legacy)', 'bottomBarAngle'],
    ['Droop', 'droop'],
    ['Preload', 'preload'],
  ];
