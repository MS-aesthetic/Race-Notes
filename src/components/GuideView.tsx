...
const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    summary: 'A weekend holds every run from that race night or test day.',
    steps: [
      { text: 'Open the Dashboard and tap + Race Weekend.' },
      ...
      { text: 'Crew Chief saves that as the Starting Setup and uses a Live-Trackside Setup for changes during the weekend.' },
      { lead: 'Weather:', text: 'Tap the weather widget to pull current conditions by GPS, or type a zip code if GPS is blocked.' },
      { text: 'Creating the weekend makes it active but does not start a run. Add notes and weather whenever you are ready.' },
      { text: 'Finish Weekend saves a Raced Setup after a Feature, or a Finished Setup for a test day, then makes an editable Current Setup.' },
    ],
    tip: 'All weekends stay in one list, newest on top — tap one to see its runs.',
  },
  {
    id: 'session',
    icon: 'timer',
    ...
    steps: [
      { text: 'Create and activate a weekend first. The Dashboard and Sessions weekend list show which weekend is active.' },
      { text: 'On the Sessions tab tap Log Run, then choose Test, Hot Laps, Qualifying, Heat Race, or Feature. The run always belongs to the active weekend.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { text: 'Saved-list edits apply to Main Checklist jobs at the next weekend reset.' },
    ],
  },
  {
    id: 'service',
