...
const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { text: 'Creating the weekend makes it active but does not start a session. Add notes, weather, or other tracking details whenever you are ready.' },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { text: 'On the Sessions tab tap New Session, then choose the session type: Test, Hot Laps, Qualifying, Heat Race, or Feature. The session always belongs to the active weekend.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { text: 'To add a reusable group, select a template and tap Import. Imported items are fresh unchecked copies.' },
      { text: 'Check items off as they get done. Open Main Checklist items also show on Dashboard.' },
    ],
  },
  {
    id: 'assign',
