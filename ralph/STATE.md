...
| 6B | Setup history lifecycle: immutable baseline, editable Weekend Setup, always-available Finish Weekend, immutable final snapshot, editable Current Setup copy | 🔴 SOL QA FAIL 2 — missing event setup fallback, no-link legacy cross-car fallback, stale recovery reuse, relational Weekend lock; Terra repair 2 next | 2a941d3 + 874fecc |
