...
| UXF-3 | Starting / Live-Trackside / Raced-or-Finished setup labels | in_progress | 1 | — | 72ea4f8 | Terra CODE_PASS: display-only lifecycle helpers, legacy render mapping, Feature inference, harness, exact lint baseline, 554-module build, diff, and cavecrew review pass. Independent SOL QA next. |
