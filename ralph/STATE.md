...
| UXF-4 | Load graph travel axis + measured-height display | in_progress | 1 | — | 0c2c827 | Terra CODE_PASS: upward travel axes, common comparison zero, raw-height SVG detail/PNG labels, focused harness, exact lint baseline, build, diff, and cavecrew review pass. SOL QA next; authenticated chart runtime unavailable on localhost. |
