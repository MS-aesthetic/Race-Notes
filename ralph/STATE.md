...
| 6B | Setup history lifecycle: immutable baseline, editable Weekend Setup, always-available Finish Weekend, immutable final snapshot, editable Current Setup copy | 🔴 SOL QA FAIL 1 — cross-car new-weekend source, legacy Finish, partial-finish recovery/dedupe; Terra repair next | 2a941d3 |
