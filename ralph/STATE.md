...
| 6B | Setup history lifecycle: immutable baseline, editable Weekend Setup, always-available Finish Weekend, immutable final snapshot, editable Current Setup copy | 🟡 Terra repair 2 CODE_PASS; awaiting SOL QA attempt 3; C7 locked | 2a941d3 + 874fecc + 7b58b30 |
