...
| 6B | Setup history lifecycle: immutable baseline, editable Weekend Setup, always-available Finish Weekend, immutable final snapshot, editable Current Setup copy | 🟡 Terra CODE_PASS + local RUNTIME_PASS; live migration/draft verified; awaiting SOL QA | 2a941d3 |
