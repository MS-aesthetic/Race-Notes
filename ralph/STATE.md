...
| 6B | Setup history lifecycle: immutable baseline, editable Weekend Setup, always-available Finish Weekend, immutable final snapshot, editable Current Setup copy | 🟡 Terra repair complete; awaiting SOL QA attempt 2; C7 locked | 2a941d3 + 874fecc |
