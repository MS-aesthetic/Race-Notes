...
| UXF-4 | Load graph travel axis + measured-height display | in_progress | 2 | — | 0c2c827 | SOL QA attempt 1 FAIL (88): all math/data/export/build gates pass; point controls lack visible keyboard focus and comparison touch target is only 8px. SOL fixer owns attempt 2; Terra retired. |
