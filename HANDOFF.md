...
> - **Chunk status:** ✅ **1–5** through Trackside Setups (`d5ef1f4`) and ✅ **6A** setup/measurement refinement (`ae9395b`, SOL QA PASS). **6B** setup-history lifecycle is next, then **7** expanded Quick Adjust. Former Trackers chunk becomes **8**; export/help/final sweep becomes **9**.
