...
| `C:\Users\maxx\antigravity\Race-Notes\.worktrees\v3` | `preview-v3` | **Active UX dev tree.** Chunks 1–9 and UXF-1/2/3/8 complete; UXF-4 next. UXF-3 feature `72ea4f8` passed SOL QA at 97. Web build works here. Local gitignored debug-only Gradle scaffolding may exist from prior QA; it is not committed release configuration. |
