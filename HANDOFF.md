...
> - **Chunk status:** ✅ **1–6B**. SOL QA attempt 3 closed C6B after feature `2a941d3` and repairs `874fecc`/`7b58b30`. **7** is unlocked for Terra build. Trackers is **8**; export/help/final sweep is **9**.
