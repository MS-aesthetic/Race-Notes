...
**Branch under review:** `codex/hide-scrollbars` @ `ab6b98a` (worktree `.worktrees\hide-scrollbars`), plus two documentation commits, unmerged from `master@47db364`.
