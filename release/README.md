...
- `CrewChief-5.1.3-release.apk` — signed direct-install package with headset launcher icon and native startup fix.
...
- Direct APK: version code `21`, version name `5.1.3`
